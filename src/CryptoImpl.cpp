...
namespace crypto{
   ...
   string CryptoException::what() const noexcept{
           return errorMessage;
   }
   ...
   void Crypto::setKexAlg(void)     anyexcept{
      bool    found = false;
      size_t  idx   = 0;
      for(auto i = clientKexAlg.cbegin(); i != clientKexAlg.cend(); ++i){
   ...
   void Crypto::setMacAlgCtS(void)  anyexcept{
      bool    found = false;
      size_t  idx   = 0;
      for(auto i = clientMacCtSAlg.cbegin(); i != clientMacCtSAlg.cend(); ++i){
   ...
   void Crypto::setMacAlgStC(void)  anyexcept{
      bool    found = false;
      size_t  idx   = 0;
      for(auto i = clientMacStCAlg.cbegin(); i != clientMacStCAlg.cend(); ++i){
